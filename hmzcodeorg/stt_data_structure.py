...
class StreamDataStructure ():
    ...
    def get_data_from_pts (self):
        ...
        print (f"get_data_from_pts ,pts={pts} hpts={hpts} tpts={tpts} == {pts < hpts or pts > tpts and tpts-pts >= G_CHUNK_MS}", file=sys.stderr)
        ...
        print (f"Resending {self.old_data_sent_ms} ms data", file=sys.stderr)
